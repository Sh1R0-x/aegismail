        ...
        $this->get('/dashboard')
            ...
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->has('recentReplies.0', fn (Assert $reply) => $reply
                    ...
                    ->where('time', '2026-03-15T10:15:00+01:00')
                    ->etc()
                )
                ->has('recentAlerts', 1)
        ...
        $this->get('/contacts')
            ...
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->has('contacts.0', fn (Assert $contact) => $contact
                    ...
                    ->where('lastActivityAt', '2026-03-15T10:30:00+01:00')
                    ->etc()
                )
                ->has('contacts.1', fn (Assert $contact) => $contact
                    ...
                    ->where('lastActivityAt', '2026-03-15T11:00:00+01:00')
                    ->etc()
                )
                ->has('contacts.2', fn (Assert $contact) => $contact
                    ...
                    ->where('excluded', true)
                    ->where('unsubscribed', false)
                    ->where('lastActivityAt', '2026-03-15T12:30:00+01:00')
                    ->etc()
                )
                ->has('organizations', 1)
