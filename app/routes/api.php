...
Route::post('/campaigns/{campaign}/clone', [CampaignManagementController::class, 'clone'])->withTrashed();
Route::delete('/campaigns/{campaign}', [CampaignManagementController::class, 'destroy'])->withTrashed();
