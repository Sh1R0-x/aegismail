...
const statusMap = {
  ...
  soft_bounced:       { label: 'Soft bounce',      class: 'border-orange-200 bg-orange-50 text-orange-700',        dot: true, dotClass: 'bg-orange-500' },
  hard_bounced:       { label: 'Hard bounce',      class: 'border-red-300 bg-red-100 text-red-800',                dot: true, dotClass: 'bg-red-600' },
